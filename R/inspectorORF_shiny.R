...
#' @return a shiny object if launch = FALSE
#' @export
  ...
  shinydashboard::dashboardPage(
    ...
    shinydashboard::dashboardSidebar(
      shinydashboard::sidebarMenu(
        ...
        shinydashboard::menuItem("Data", tabName = "plot", icon = shiny::icon("table")),
          ...
          shiny::fluidRow(
            shinydashboard::box(
              ...
              shiny::conditionalPanel(
                ...
                shiny::hr(),
                shiny::h4(shiny::strong("Step 3"), " - Select if BED file consists of gene level or transcript level information"),
                shiny::radioButtons(
                  inputId = "track_type",
                  label = "Select track type:",
                  choices = c("Transcript" = "transcript", "Gene" = "gene"),
                  selected = "transcript",
                  inline = TRUE
                ),
                shiny::hr(),
              ...
              shiny::conditionalPanel(
                ...
                shiny::actionButton("process_gene", "Generate gene tracks"),
                shiny::actionButton("process_transcript", "Generate transcript tracks"),
                shiny::hr(),
